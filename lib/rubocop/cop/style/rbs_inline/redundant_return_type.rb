        ...
        class RedundantReturnType < Base # rubocop:disable Metrics/ClassLength
          ...
          def process(node) #: void
            ...
            if prefer_inline_signature?
              add_offense_for_return_annotation(return_annotation)
            else
              add_offense_for_signature(signature_comment)
            end
          end
          ...
          def add_offense_for_return_annotation(annotation) #: void # rubocop:disable Metrics/AbcSize
          ...
          def add_offense_for_signature(signature_comment) #: void
          ...
          # @rbs annotation: RBS::Inline::AST::Annotations::ReturnType
          def find_comment_range(annotation) #: Parser::Source::Range? # rubocop:disable Metrics/AbcSize
            loc = annotation.source.comments.first&.location or return
          ...
          def signature_range_with_surrounding(comment) #: Parser::Source::Range # rubocop:disable Metrics/AbcSize, Metrics/PerceivedComplexity
