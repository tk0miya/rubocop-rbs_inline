  ...
  context 'when YARD @param exists with RBS method signature' do
    it 'registers an offense' do
      expect_offense(<<~RUBY)
        ...
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Redundant YARD `@param` comment. Use RBS inline annotations instead.
        #: (String) -> void
        def greet(name)
        end
      RUBY
  ...
  context 'when YARD @return exists with RBS method signature' do
    it 'registers an offense' do
      expect_offense(<<~RUBY)
        ...
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Redundant YARD `@return` comment. Use RBS inline annotations instead.
        #: (String) -> String
        def greet(name)
        end
      RUBY
  ...
  context 'when YARD @option exists with RBS method signature' do
    it 'registers an offense' do
      expect_offense(<<~RUBY)
        ...
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Redundant YARD `@option` comment. Use RBS inline annotations instead.
  ...
  context 'when YARD @yield exists with RBS method signature' do
    it 'registers an offense' do
      expect_offense(<<~RUBY)
        ...
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Redundant YARD `@yield` comment. Use RBS inline annotations instead.
        #: () { (String) -> void } -> void
        def each(&block)
        end
      RUBY
  ...
  context 'when YARD @yieldparam exists with RBS method signature' do
    it 'registers an offense' do
      expect_offense(<<~RUBY)
        ...
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Redundant YARD `@yieldparam` comment. Use RBS inline annotations instead.
        #: () { (String) -> void } -> void
        def each(&block)
        end
      RUBY
  ...
  context 'when YARD @yieldreturn exists with RBS method signature' do
    it 'registers an offense' do
      expect_offense(<<~RUBY)
        ...
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Redundant YARD `@yieldreturn` comment. Use RBS inline annotations instead.
        #: () { () -> bool } -> void
        def each(&block)
        end
      RUBY
